...
export const loadSubCategory = createAsyncThunk(ActionSubCategory.LOAD_SUB_CATEGORY,() => api.axiosSubCategoryLoad());
...
const subCategorySlice = createSlice({
    ...
    extraReducers: (builer) => {
        builer
        .addCase(loadSubCategory.fulfilled, (state, action) => {
