...
function UserProfile(): JSX.Element {
  ...
  const handleFormSubmit = (data: { productName: string, productType: string, gender: string, compositions: Array<{ material: string, quantity: number }> }) => {
  ...
  return (
    <>
      <div className="user-profile">
        <img src={'https://cdn.fishki.net/upload/post/2018/04/09/2564770/1-4d137341-2db8-49c6-83de-e8ef75519d43.jpg'} alt="User avatar" className="user-avatar" />
